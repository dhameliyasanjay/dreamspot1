                                                ...
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img src="{{asset('wp-content/uploads/sites/91/2022/09/web-inner.jpeg')}}"
                                                             alt="Web Design" title="Web Design">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="tab-pane course-tab-panel-overview course-tab-panel active" id="tab-overview">
                                                                <div class="course-description" id="learn-press-course-description">
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <p>
                                                                            Web design refers to the design of websites that are displayed on the internet. It usually refers to the user experience aspects
                                                                            of website development rather than software development. Web design used to be focused on designing websites for desktop browsers;
                                                                            however, since the mid-2010s, design for mobile and tablet browsers has become ever-increasingly important.<br>
                                                                            A web designer works on the appearance, layout, and, in some cases, content of a website. Appearance, for instance, relates to the
                                                                            colors, font, and images used. Layout refers to how information is structured and categorized. A good web design is easy to use,
                                                                            aesthetically pleasing, and suits the user group and brand of the website. Many webpages are designed with a focus on simplicity,
                                                                            so that no extraneous information and functionality that might distract or confuse users appears.
                                                                        </p>
                                                                        ...
                                                                        <ul class="thim-list-content">
                                                                            ...
                                                                            <li>Illustrator</li>
                                                                            <li>Figma</li>
                                                                            <li>Getting Familiar with HTML</li>
                                                                            ...
                                                                            <li>Tailwind CSS</li>
                                                                            <li>Add Some Animation Using JavaScript & jQuery</li>
                                                                            <li>SASS / SCSS</li>
                                                                            <li>Wordpress</li>
                                                                            <li>Live Project</li>
                                                                        </ul>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form method="POST" action="{{route('courses.store')}}" class="lgx-contactform">
                                                                                            ...
                                                                                            <div>
                                                                                                ...
                                                                                                <input type="hidden" name="course" value="Web-design">
                                                                                                <div class="form-group">
                                                                ...
                                                                <div class="learnpress-course-curriculum" data-section="" data-id="">
                                                                    <ul class="lp-skeleton-animation">
                                                                        <li style="width: 100%; height: 50px; color:black">
                                                                            <p class="main_div">Who can join Web design Course?</p>
                                                                        </li>
                                                                        <li class="base_div">10th / 12 th Pass or Fail Students</li>
                                                                        <li class="base_div">Interested in Designing & Internet</li>
                                                                        <li class="base_div">Housewife, Businessmen</li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Why should I learn Web Design?</p>
                                                                        </li>
                                                                        <li class="base_div">100% Job Guarantee</li>
                                                                        <li class="base_div">Rich Learning Content</li>
                                                                        <li class="base_div">Taught by Experienced Prof.</li>
                                                                        <li class="base_div">Industry Orientd Projects</li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">What after Web Designing course?</p>
                                                                        </li>
