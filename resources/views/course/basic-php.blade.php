                ...
                <div class="top_site_main style_heading_3" style="color: #000000;">
                    ...
                    <div class="page-title-wrapper">
                        <div class="banner-wrapper container">
                            <h2 class="page-title">Basic PHP – Learn Basic PHP Language</h2>
                        ...
                        <div id="lp-single-course" class="lp-single-course learn-press-4">
                            <div id="learn-press-course" class="course-summary learn-press">
                                <div class="course-info">
                                    <h1 class="entry-title" itemprop="name">Basic PHP </h1>
                                            ...
                                            <div class="course-thumbnail">
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img src="{{asset('wp-content/uploads/sites/91/2022/09/php-inner.jpg')}}"
                                                             alt="Basic PHP" title="Basic PHP" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="entry-content-left">
                                                    <div id="learn-press-course-tabs" class="course-tabs">
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane course-tab-panel-overview course-tab-panel active" id="tab-overview">
                                                                <div class="course-description" id="learn-press-course-description">
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <p>
                                                                            PHP is an acronym for Hypertext Pre-processor.<br>
                                                                            Each business is developing with the assistance of sites. PHP is begins in 1995 and
                                                                            still becomes the most popular programming language for web applications.<br>
                                                                            The utilization of the web is comprehensive, there are more than 2.0 billion sites online with thousand more included every day and furthermore,
                                                                            5 million web journals live and included quickly progressively.<br>
                                                                            PHP course in Web improvement has two divisions, Front end Development that is additionally called customer side web advancement.
                                                                            Back-end web advancement that is called server-side web advancement.<br>
                                                                            Customer side web advancement involves making a site that what clients see when they burden web application, the plan, and substance.<br>
                                                                            Server-side web advancement controls what to look like after the scene of web application, back end improvement utilizes various coding language and structure.
                                                                        </p>

                                                                        <h4>LEARNING OUTCOMES</h4>
                                                                        <ul class="thim-list-content">
                                                                            <li>Introduction of PHP</li>
                                                                            <li>Control structures : Logical Expressions</li>
                                                                            <li>Control structures : Loops</li>
                                                                            <li>Exploring Data Type</li>
                                                                            ...
                                                                            <li>OOPS Concept</li>
                                                                            <li>Working with file and Directories</li>
                                                                            <li>Sending Mails</li>
                                                                        ...
                                                                        <h4 style="padding-top: 14px">SOFTWARE TO LEARN</h4>
                                                                        <ul class="thim-list-content">
                                                                            <li>MY SQL</li>
                                                                            <li>PHP Core or Javascript</li>
                                                                        </ul>
                                                                        <br>
                                                                        ...
                                                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                            <div class="modal-dialog" role="document" style="padding-top: 9rem">
                                                                                <div class="modal-content" >
                                                                                    <div class="modal-header">
                                                                                        <h3 class="modal-title" id="exampleModalLabel">Submit Your Information</h3>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form method="POST" action="{{route('courses.store')}}" class="lgx-contactform">
                                                                                            @csrf
                                                                                            <div>
                                                                                                ...
                                                                                                <input type="hidden" name="course" value="Basic PHP">
                                                                                                <div class="form-group">
                                                                                                    <textarea class="form-control" name="message" rows="5" placeholder="We expect drop some line from you..." required></textarea>
                                                                                                </div>
                                                                                            </div>
                                                            ...
                                                            <style>
                                                                .base_div{
                                                                    width: 100%; height: 30% !important;padding-left: 8px;
                                                                }
                                                                .main_div{
                                                                ...
                                                                <div class="learnpress-course-curriculum" data-section="" data-id="">
                                                                    <ul class="lp-skeleton-animation">
                                                                        <li style="width: 100%; height: 50px; color:black">
                                                                            <p class="main_div">Who can join Web Development Course?</p>
                                                                        </li>
                                                                        <li class="base_div">12 pass or diploma or engineering novice students.</li>
                                                                        <li class="base_div">A person interested in learning about logical things</li>
                                                                        <li class="base_div">Web Designer who wants to learn programming</li>
                                                                        <li class="base_div">Individuals who want to become software developers.</li>
                                                                        <li class="base_div">A person who wants to pursue higher studies in IT or go abroad for a job.</li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Why should I learn Web Development?</p>
                                                                        </li>
                                                                        <li class="base_div">Completely practical field.</li>
                                                                        <li class="base_div">Many scopes in India and even out of the country</li>
                                                                        <li class="base_div">Increasing scopes day by day</li>
                                                                        <li class="base_div">A big opportunity to become Independent</li>
                                                                        <li class="base_div">Most of the works are done by using websites and intenet</li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">What after Web Development course?</p>
                                                                        </li>
                                                                        <li class="base_div">Huge scope to get job as a Web Developer in Multinational IT Companies</li>
                                                                        <li class="base_div">You can startup your company with minimum investment</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="thim-about-author">
                                                                    <div class="author-wrapper">
                                                                        <div class="author-avatar">
                                                                            <a href="../../profile/keny/index.html">
                                                                                <img alt='author avatar'
                                                                                     src='https://secure.gravatar.com/avatar/b08d0d3bc9bf251a412e53566ac82b54?s=110&amp;r=g'
                                                                                     srcset='https://secure.gravatar.com/avatar/b08d0d3bc9bf251a412e53566ac82b54?s=220&#038;r=g 2x'
                                                                        ...
                                                                        <div class="author-bio">
                                                                            ...
                                                                            <div class="author-description">
                                                                                <p>
                                                                                    Lorem ipsum dolor sit amet. Qui incidunt dolores non similique ducimus et debitis molestiae. Et autem quia eum reprehenderit voluptates est
                                                                                    reprehenderit illo est enim perferendis est neque sunt. Nam amet sunt aut vero mollitia ut ipsum corporis vel
                                                                                    facere eius et quia aspernatur qui fugiat repudiandae. Et officiis inventore
                                                                                    et quis enim ut quaerat corporis sed reprehenderit odit sit saepe distinctio et accusantium repellendus ea enim harum.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <ul class="thim-social-share">
                                                ...
                                                <li>
                                                    <div class="facebook-social">
                                                        <a target="_blank" class="facebook" href="https://www.facebook.com/" title="Facebook">
                                                ...
                                                <li>
                                                    <div class="pinterest-social">
                                                        <a target="_blank" class="pinterest" href="https://in.pinterest.com/" onclick="window.open(this.href); return false;" title="Pinterest">
                                ...
                                <div class="thim-related-course">
                                    ...
                                    <div class="thim-course-grid">
                                        <div class="thim-carousel-wrapper" data-visible="3" data-itemtablet="2" data-itemmobile="1" data-pagination="1">
                                                ...
                                                <div class="course-item">
                                                    ...
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title"
                                                            ...
                                                            <a href="{{route('full-stack-dev')}}" rel="bookmark">Full
                                                                Stack Development</a>
                                                        </h1>
                                                    ...
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('web-development')}}">
                                                            <img
                                                                ...
                                                                alt="web-development" title="web-development" width="400"
                                                                style="height: 13rem;object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
                                            ...
                                            <div id="post-18506"
                                                 class="course-grid-3 lpr_course post-18506 lp_course type-lp_course status-publish has-post-thumbnail hentry course_category-teaching-online course">
                                                <div class="course-item">
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('ui-ux')}}">
                                                            <img src="{{asset('wp-content/uploads/sites/91/2022/09/ui-ux2.jpg')}}"
                                                                 alt="UI/UX & Graphics Design" title="UI/UX & Graphics Design" width="400" style="height: 13rem;object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
                                                        ...
                                                        <div class="course-meta">
                                                            <div class="course-lesson">
                                                                <div class="value"><i aria-hidden="true" class="tk tk-file-invoice"></i>11</div>
                                                            </div>
                                                            <div class="course-students">
                                                                <label>Students</label>
                                                                <div class="value"><i class="tk tk-students-friend"></i>
                                            ...
                                            <div id="post-5394"
                                                ...
                                                <div class="course-item">
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('node-js')}}">
                                                            <img
                                                                src="{{asset('wp-content/uploads/sites/91/2022/09/nodejs.png')}}"
                                                                alt="node-js" title="node-js" width="400"
                                                                style="height: 13rem;object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title"
                                                            style="display: flex;justify-content: space-evenly;align-items: center;">
                                                            <a href="{{route('node-js')}}" rel="bookmark">Node JS</a>
                                                        </h1>
                                                        <div class="course-meta">
                                                            <div class="course-lesson">
                                                                <div class="value">
                                                ...
                                                <div class="course-item">
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('advance-laravel')}}">
                                                            <img src="{{asset('wp-content/uploads/sites/91/2022/09/laravel-inner.png')}}"
                                                                 alt="advance laravel" title="advance laravel" width="400" style="height: 13rem;object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title" style="display: flex;justify-content: space-evenly;align-items: center;">
                                                            <a href="{{route('advance-laravel')}}" rel="bookmark">Advance laravel</a>
                                                        </h1>
                                                        <div class="course-meta">
                                                            <div class="course-lesson">
                                                                <div class="value">
                                                ...
                                                <div class="course-item">
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('web-design')}}">
                                                            <img src="{{asset('wp-content/uploads/sites/91/2022/09/web-inner.jpeg')}} "
                                                                 alt="Basic PHP" title="basic-php" width="400" style="height: 13rem;object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title" style="display: flex;justify-content: space-evenly;align-items: center;">
                                                            <a href="{{route('web-design')}}" rel="bookmark">Web Design</a>
                                                        </h1>
                                                        <div class="course-meta">
                                                            <div class="course-lesson">
                                                                <div class="value"><i aria-hidden="true" class="tk tk-file-invoice"></i>0
                                                                </div>
                                                            </div>
                                                            <div class="course-students">
                                                                <label>Students</label>
