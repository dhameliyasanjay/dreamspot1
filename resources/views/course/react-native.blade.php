                ...
                <div class="top_site_main style_heading_3" style="color: #000000;">
                    ...
                    <div class="page-title-wrapper">
                        <div class="banner-wrapper container">
                            <h2 class="page-title">React Native</h2>
                        ...
                        <div id="lp-single-course" class="lp-single-course learn-press-4">
                            <div id="learn-press-course" class="course-summary learn-press">
                                <div class="course-info">
                                    <h1 class="entry-title" itemprop="name">React Native</h1>
                                            ...
                                            <div class="course-thumbnail">
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img
                                                            src="{{asset('wp-content/uploads/sites/91/2022/09/ReactNative.png')}}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="course-description"
                                                                    ...
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <p>React Native is used by organizations
                                                                            worldwide to create cross-platform
                                                                            phone/tablet apps with one code
                                                                            base. This means that you can write code
                                                                            easily that will run on iPhones, iPads, and
                                                                            Android phones and
                                                                            tablets without having to rewrite it in two
                                                                            or more languages -- just one. And that one
                                                                            language is easy to learn
                                                                            if you know React and JavaScript because it
                                                                            is React and JavaScript! Furthermore, these
                                                                            apps run natively and
                                                                            can be deployed to the Apple AppStore or the
                                                                            Google Play store, not web apps that run in
                                                                            some adapter or
                                                                            translator. So they're faster and more
                                                                            reliable
                                                                        </p>
                                                                        ...
                                                                        <ul class="thim-list-content">
                                                                            ...
                                                                            <li>Hello React Native
                                                                            </li>
                                                                            <li>React and Redux reviews (when needed)
                                                                            </li>
                                                                            <li>The Development Process
                                                                            </li>
                                                                            <li>Single-value Controls</li>
                                                                            <li>Platform-specific Development</li>
                                                                            <li>Layout Components</li>
                                                                            <li>Flexbox for Native Layouts</li>
                                                                            <li>Styling React Native Apps
                                                                            </li>
                                                                            <li>Navigation
                                                                            </li>
                                                                            <li>Ajax in React Native</li>
                                                                            <li>List Components
                                                                            </li>
                                                                            <li>Touchables and Buttons</li>
                                                                        </ul>
                                                                ...
                                                                <div class="learnpress-course-curriculum"
                                                                    ...
                                                                    <ul class="lp-skeleton-animation">
                                                                        <li style="width: 100%; height: 50px; color:black">
                                                                            <p class="main_div">Why should I pursue
                                                                                React Native Course?</p>
                                                                        </li>
                                                                        <li class="base_div"><p>React Native is now
                                                                                among the most popular frameworks for
                                                                                building native mobile applications. It
                                                                                combines React and JavaScript
                                                                                technologies and allows developers to
                                                                                build applications across platforms
                                                                                paving the way for more seamless
                                                                                interaction between teams.</p></li>
                                                                        ...
                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">What will I accomplish
                                                                                after pursuing Zeolearn’s React Native
                                                                                course?</p>
                                                                        </li>
                                                                        <li class="base_div">How to build React Native
                                                                            apps
                                                                        </li>
                                                                        <li class="base_div">Master the React Native
                                                                            environment
                                                                        </li>
                                                                        <li class="base_div">Learn to make reusable
                                                                            components
                                                                        </li>
                                                                        <li class="base_div">Build attractive mobile
                                                                            apps
                                                                        </li>
                                                                        <li class="base_div">Publish your apps on Apple
                                                                            and Google Play Store
                                                                        </li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Will I get any
                                                                                certification on completion of the
                                                                                course?</p>
                                                                        </li>
                                                                        <li class="base_div">You will receive React
                                                                            Native certification in the form of a course
                                                                        ...
                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">What project am I
                                                                                expected to do?</p>
                                                                        </li>
                                                                        <li class="base_div">Towards the end of the
                                                                            course, all participants will be required to
                                                                            work on a project to get hands on
                                                                            familiarity with the concepts learnt. You
                                                                            will build your own native apps on android
                                                                            and iOS platforms with support from your
                                                                            mentors. This project, which can also be a
                                                                            live industry project, will be reviewed by
                                                                            our instructors and industry experts. On
                                                                            successful completion, you will be awarded a
                                                                            certification.
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                            ...
                                            <div id="post-5394"
                                                ...
                                                <div class="course-item">
                                                    ...
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title"
                                                            style="display: flex;justify-content: space-evenly;align-items: center;">
                                                            <a href="{{route('ui-ux')}}" rel="bookmark">UI/UX & Graphics
                                                                Design</a>
                                                        </h1>
                                                        <div class="course-meta">
                                                            <div class="course-lesson">
