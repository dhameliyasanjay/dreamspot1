                ...
                <div class="top_site_main style_heading_3" style="color: #000000;">
                    ...
                    <div class="page-title-wrapper">
                        <div class="banner-wrapper container">
                            <h2 class="page-title">Laravel Web Development</h2>
                        ...
                        <div id="lp-single-course" class="lp-single-course learn-press-4">
                            <div id="learn-press-course" class="course-summary learn-press">
                                <div class="course-info">
                                    <h1 class="entry-title" itemprop="name">Advance Laravel</h1>
                                                ...
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img src="{{asset('wp-content/uploads/sites/91/2022/09/laravel-inner.png')}}"
                                                             alt="advance laravel" title="advance laravel" style="height: 34rem">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="tab-pane course-tab-panel-overview course-tab-panel active" id="tab-overview">
                                                                <div class="course-description" id="learn-press-course-description">
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <p>
                                                                            Laravel is a free and open-source PHP web framework, created by Taylor Otwell and intended for the development of
                                                                            web applications following the model–view–controller architectural pattern and based on Symfony.
                                                                            Laravel offers more number of functionalities which incorporate the basic features of PHP frameworks like CodeIgniter,
                                                                            Yii and other programming languages like Ruby on Rails. Laravel has plenty of set of features that increase the speed of web development.
                                                                            Laravel has a unique feature that creates a modular packaging system with less dependency manager, many ways for accessing
                                                                            relational databases, its utilities which help in application deployment, maintenance, and orientation syntax.
                                                                        </p>

                                                                        <h4>LEARNING OUTCOMES</h4>
                                                                        <ul class="thim-list-content">
                                                                            <li>Introduction to Laravel PHP Framework</li>
                                                                            <li>Laravel Installation</li>
                                                                            <li>Routing</li>
                                                                            <li>MVC in Laravel</li>
                                                                            <li>Laravel Blade Template With Html Template</li>
                                                                            <li>Migrtations</li>
                                                                            <li>Blade Template With HTML Template</li>
                                                                            ...
                                                                            <li>Laravel Security & Session</li>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form method="POST" action="{{route('courses.store')}}" class="lgx-contactform">
                                                                                            ...
                                                                                            <div>
                                                                                                ...
                                                                                                <input type="hidden" name="course" value="advance-laravel">
                                                                                                <div class="form-group">
                                        ...
                                        <div class="thim-carousel-wrapper" data-visible="3" data-itemtablet="2" data-itemmobile="1" data-pagination="1">
                                                    ...
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('web-design')}}">
                                                            <img src="{{asset('wp-content/uploads/sites/91/2022/09/web-inner.jpeg')}}"
                                                                 alt="web design" title="web design" width="400" style="height: 13rem;object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title" style="display: flex;justify-content: space-evenly;align-items: center;">
                                            ...
                                            <div id="post-5345"
                                                ...
                                                <div class="course-item">
                                                    ...
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title" style="display: flex;justify-content: space-evenly;align-items: center;">
                                                            <a href="{{route('basic-php')}}" rel="bookmark">Basic PHP</a>
                                                        </h1>
                                                        <div class="course-meta">
                                                            <div class="course-lesson">
