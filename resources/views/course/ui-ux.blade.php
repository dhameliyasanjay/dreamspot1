                ...
                <div class="top_site_main style_heading_3" style="color: #000000;">
                    ...
                    <div class="page-title-wrapper">
                        <div class="banner-wrapper container">
                            <h2 class="page-title">UI/UX & Graphics Design</h2>
                        ...
                        <div id="lp-single-course" class="lp-single-course learn-press-4">
                            <div id="learn-press-course" class="course-summary learn-press">
                                <div class="course-info">
                                    <h1 class="entry-title" itemprop="name">UI/UX & Graphics Design</h1>
                                                ...
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img src="{{asset('wp-content/uploads/sites/91/2022/09/ui-ux2.jpg')}}"
                                                            alt="UI/UX & Graphics Design" title="courses-1" style="height: 35rem">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="entry-content-left">
                                                    <div id="learn-press-course-tabs" class="course-tabs">
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane course-tab-panel-overview course-tab-panel active" id="tab-overview">
                                                                <div class="course-description" id="learn-press-course-description">
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <p>Graphic design is a craft where professionals create visual content to communicate messages. By applying visual hierarchy and
                                                                            page layout techniques, designers use typography and pictures to meet users’ specific needs and focus on the logic of
                                                                        ...
                                                                        <ul class="thim-list-content">
                                                                            ...
                                                                            <li>Introduction to App Design & Web Design</li>
                                                                            ...
                                                                            <li>How to use Colors in Design (Color Management)</li>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form method="POST" action="{{route('courses.store')}}" class="lgx-contactform">
                                                                                            ...
                                                                                            <div>
                                                                                                ...
                                                                                                <input type="hidden" name="course" value="UI-UX">
                                                                                                <div class="form-group">
                                                            ...
                                                            <style>
                                                                .base_div{
                                                                    width: 100%;padding-left:8px;height: 30% !important;
                                                                }
                                                                .main_div{
                                                                ...
                                                                <div class="learnpress-course-curriculum" data-section="" data-id="">
                                                                    <ul class="lp-skeleton-animation">
                                                                        <li style="width: 100%; height: 50px; color:black">
                                                                            <p class="main_div">Who can join UI/UX & Graphics Design?</p>
                                                                        </li>
                                                                        <li class="base_div"><p>10th / 12 th Pass or Fail Students</p></li>
                                                                        <li class="base_div"><p>Interested in Designing & Internet</p></li>
                                                                        <li class="base_div"><p>Housewife, Businessmen</p></li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Why should I learn UI/UX & Graphics Design?</p>
                                                                        </li>
                                                                        ...
                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">What after UI/UX & Graphics Design course?</p>
                                                                        </li>
                                                                        <li class="base_div">100% Job Guarantee</li>
                                                                        <li class="base_div">Rich Learning Content</li>
                                                                        <li class="base_div">Taught by Experienced Prof.</li>
                                                    ...
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('basic-php')}}">
                                                            <img src="{{asset('wp-content/uploads/sites/91/2022/09/php-inner.jpg')}} "
                                                                alt="Basic PHP" title="basic-php" width="400" height="300" style="object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
                                                        <h1 class="course-title" style="display: flex;justify-content: space-evenly;align-items: center;">
