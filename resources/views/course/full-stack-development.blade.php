                ...
                <div class="top_site_main style_heading_3" style="color: #000000;">
                    ...
                    <div class="page-title-wrapper">
                        <div class="banner-wrapper container">
                            <h2 class="page-title">Full Stack Development</h2>
                        ...
                        <div id="lp-single-course" class="lp-single-course learn-press-4">
                            <div id="learn-press-course" class="course-summary learn-press">
                                <div class="course-info">
                                    <h1 class="entry-title" itemprop="name">Full Stack Development</h1>
                                                ...
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img
                                                            ...
                                                            alt="Full Stack Development" title="Full Stack Development"
                                                            style="height: 35rem">
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="course-description"
                                                                    ...
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <p>We have grown an expert in the whole lot that
                                                                            goes into developing front-end and back-end,
                                                                            working on both sides to accelerate the
                                                                            development cycles. Our full-stack
                                                                            developers have a wide knowledge switching
                                                                            roles between frontend and backend
                                                                            development delivering end-to-end solution
                                                                            to our customers.
                                                                        </p>

                                                                        <h4>LEARNING OUTCOMES</h4>
                                                                        <h5>Get started with web development</h5>
                                                                        <p>Brush up on your knowledge of software
                                                                            development fundamentals; Agile and Scrum
                                                                            methodologies; HTML, CSS, JavaScript to
                                                                            create dynamic websites; and GIT to manage
                                                                            version control systems.</p>
                                                                        <h5>Create websites using Front and Back-end
                                                                            frameworks</h5>
                                                                        <p>Familiarize yourself with the front and
                                                                            back-end technologies by implementing
                                                                            knowledge of Angular and Node.js. Use
                                                                            TypeScript to enable IDEs to provide a
                                                                            richer environment for spotting common
                                                                            errors as you type the code.</p>
                                                                        <h5>Create scalable and dynamic websites</h5>
                                                                        <p>Build scalable websites for diverse clients
                                                                            using REST API, Node.js, and Express.js.
                                                                            Store all your data in a highly scalable,
                                                                            flexible, and distributed NoSQL database -
                                                                            MongoDB.</p>
                                                                        <h5> Test your application</h5>
                                                                        <p>This phase will introduce you to testing and
                                                                            how it fits in the software lifecycle. It
                                                                            will provide you with hands-on training full
                                                                            stack development using GraphQL and React,
                                                                            API testing with Postman, how to deploy in
                                                                            cloud, and host your website</p>
                                                                        <h5>Full Stack MEAN Developer Capstone
                                                                            Project</h5>
                                                                        <p>Mean Stack Capstone project provides you with
                                                                            hands-on working experience — the objective
                                                                            being to develop the entire application from
                                                                            scratch, deploy it into a pseudo-production
                                                                            environment, and successfully test it.</p>

{{--                                                                        <ul class="thim-list-content">--}}
{{--                                                                            <li>Starting with Major Tools in Software.--}}
{{--                                                                            </li>--}}
{{--                                                                            <li>Introduction to App Design & Web--}}
{{--                                                                                Design--}}
{{--                                                                            </li>--}}
{{--                                                                            <li>Creating Basic Application Ideas.</li>--}}
{{--                                                                            <li>Creating Basic Websites.</li>--}}
{{--                                                                            <li>Analysis about Design.</li>--}}
{{--                                                                            <li>Different Between UI/UX.</li>--}}
{{--                                                                            <li>Develop an eye for good design</li>--}}
{{--                                                                            <li>Build a portfolio of work</li>--}}
{{--                                                                            <li>How to use Colors in Design (Color--}}
{{--                                                                                Management)--}}
{{--                                                                            </li>--}}
{{--                                                                            <li>Actual Process of Design & How to--}}
{{--                                                                                Prototype.--}}
{{--                                                                            </li>--}}
{{--                                                                            <li>Get real-world work experience</li>--}}
{{--                                                                        </ul>--}}
                                                                ...
                                                                <div class="learnpress-course-curriculum"
                                                                    ...
                                                                    <ul class="lp-skeleton-animation">
                                                                        <li style="width: 100%; height: 50px; color:black">
                                                                            <p class="main_div">Who can learn Full Stack Development Course?</p>
                                                                        </li>
                                                                        <li class="base_div"><p>To become a full-stack developer you need to have a proficient understanding of
                                                                                front-end development, back-end development, and databases. A full-stack
                                                                                developer is a part of the development team who understands all these three main
                                                                                elements of web development.</p></li>
{{--                                                                        <li class="base_div"><p>Interested in Designing--}}
{{--                                                                                & Internet</p></li>--}}
{{--                                                                        <li class="base_div"><p>Housewife,--}}
{{--                                                                                Businessmen</p></li>--}}

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Is full stack development good for beginners?</p>
                                                                        </li>
                                                                        <li class="base_div">Beginners who want to learn the Full Stack Development course can start with the
                                                                            basic language first. Once you have mastered the basics you can move on to the
                                                                            advanced topic.</li>
{{--                                                                        <li class="base_div">Rich Learning Content</li>--}}
{{--                                                                        <li class="base_div">Taught by Experienced--}}
{{--                                                                            Prof.--}}
{{--                                                                        </li>--}}
{{--                                                                        <li class="base_div">Industry Orientd Projects--}}
{{--                                                                        </li>--}}

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Is full stack developer a good career in 2023?</p>
                                                                        </li>
                                                                        <li class="base_div">yes, it is worth it to become a full-stack web developer. The full-stack web developer
                                                                            is a very important and prominent position.</li>
{{--                                                                        <li class="base_div">Rich Learning Content</li>--}}
{{--                                                                        <li class="base_div">Taught by Experienced--}}
{{--                                                                            Prof.--}}
{{--                                                                        </li>--}}
...
{{--                                                                        </li>--}}
                                                                        ...
                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">How much does a full stack developer get?</p>
                                                                        </li>
                                                                        <li class="base_div">A full stack developer salary in India is directly or indirectly dependent on how
                                                                            upskilled and updated you are.</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div
