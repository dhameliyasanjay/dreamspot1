                ...
                <div class="top_site_main style_heading_3" style="color: #000000;">
                    ...
                    <div class="page-title-wrapper">
                        <div class="banner-wrapper container">
                            <h2 class="page-title">Web Development</h2>
                        ...
                        <div id="lp-single-course" class="lp-single-course learn-press-4">
                            <div id="learn-press-course" class="course-summary learn-press">
                                <div class="course-info">
                                    <h1 class="entry-title" itemprop="name">Web Development</h1>
                                            ...
                                            <div class="course-thumbnail">
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img
                                                            src="{{asset('wp-content/uploads/sites/91/2022/09/web.jpg')}}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="course-description"
                                                                    ...
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <h5>Accessibility, Agreement, Navigability &
                                                                            Usefulness delivered to leave a strong
                                                                            impression</h5>
                                                                        <p>Great web behavior needs highly competent
                                                                            front-end implementation. Our team of master
                                                                            developers can transpose your cutting-edge
                                                                            graphic designs to clean W3C validated
                                                                            mark-up that turns out to be the best
                                                                            possible development solution for our
                                                                            clients.
                                                                        </p>
                                                                        <ul class="thim-list-content">
                                                                            <li>Custom Web Development
                                                                            </li>
                                                                            <li>
                                                                        ...
                                                                        <ul class="thim-list-content">
                                                                            <li>Programming Fundamentals – Operators,
                                                                                loops, strings, binary number system and
                                                                                decision trees
                                                                            </li>
                                                                            <li>Programming constructs – functions,
                                                                                recursions, pointers, structures,
                                                                                arrays, asymptotic notations, etc
                                                                            </li>
                                                                            <li>Problem-solving
                                                                            </li>
                                                                        </ul>
                                                                ...
                                                                <div class="learnpress-course-curriculum"
                                                                    ...
                                                                    <ul class="lp-skeleton-animation">
                                                                        <li style="width: 100%; height: 50px; color:black">
                                                                            <p class="main_div">Why should I learn web
                                                                                design?</p>
                                                                        </li>
                                                                        <li class="base_div"><p>It allows you to get
                                                                                better jobs, and thus, you can give your
                                                                                career a new start.</p></li>
                                                                        <li class="base_div"><p>Experienced professors
                                                                                will guide you through creating nice
                                                                                website designs. The instructors will
                                                                                help you improve your web design skills,
                                                                                and you will find it easy to handle live
                                                                                projects.</p></li>
                                                                        <li class="base_div"><p>Once you join the
                                                                                course, you will get the opportunity to
                                                                                work on live projects that will help you
                                                                                gain important skills.</p></li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Can I become a web
                                                                                designer without a degree?</p>
                                                                        </li>
                                                                        <li class="base_div">You don't necessarily need
                                                                            a degree to become a web designer. However,
                                                                            you must be familiar with the tools or the
                                                                            coding languages that play a crucial role in
                                                                            the profession.
                                                                        </li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">How long does it take to
                                                                                become a Web-designer?</p>
                                                                        </li>
                                                                        <li class="base_div">It takes around 5 to 6
                                                                            months to learn web development from
                                                                            scratch. This is if you spend a few hours
                                                                            studying every day. Some people learn in
                                                                            just a few months. However, it takes others
                                                                        ...
                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">How difficult is
                                                                                Web-designing?</p>
                                                                        </li>
                                                                        <li class="base_div">Coding and design skills
                                                                            are more in demand today than ever before,
                                                                            but both learning and executing web design
                                                                            can be daunting for beginners, novices, and
                                                                            professionals alike.
                                                                        </li>
                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black">
                                                                            <p class="main_div">Is web designing
                                                                                easy?</p>
                                                                        </li>
                                                                        <li class="base_div">But just the idea of
                                                                            getting started in web design can be
                                                                            overwhelming. ... Getting started designing
                                                                            websites is more easy than you might
                                                                            imagine. Just start with these web and
                                                                            visual design skills and you'll soon be on
                                                                            your way.
                                                                        </li>
                                                                    </ul>
                                                                </div>
