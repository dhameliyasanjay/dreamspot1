                ...
                <div class="top_site_main style_heading_3" style="color: #000000;">
                    ...
                    <div class="page-title-wrapper">
                        <div class="banner-wrapper container">
                            <h2 class="page-title">React JS</h2>
                        ...
                        <div id="lp-single-course" class="lp-single-course learn-press-4">
                            <div id="learn-press-course" class="course-summary learn-press">
                                <div class="course-info">
                                    <h1 class="entry-title" itemprop="name">React JS</h1>
                                            ...
                                            <div class="course-thumbnail">
                                                <div class="media-intro">
                                                    <div class="responsive-iframe">
                                                        <img src="{{asset('wp-content/uploads/sites/91/2022/09/react-js-inner.jpg')}}"
                                                                ...
                                                                <div class="course-description" id="learn-press-course-description">
                                                                    <div class="thim-course-content">
                                                                        ...
                                                                        <p>
                                                                            ...
                                                                            The design and the security highlights are making the React as a well-known one. Acing different advances in a similar
                                                                            area is fundamental in the field of programming occupations. For example, on the off chance that you are a front end designer,
                                                                            at that point dialects like React JS, AngularJS, and respond local is basic for vocation development.
                                                                        </p>

                                                                        <h4>LEARNING OUTCOMES</h4>
                                                                        <ul class="thim-list-content">
                                                                            <li>Intro to React.JS</li>
                                                                            <li>Environment of ReactJS</li>
                                                                            <li>ReactJS Lifecycle</li>
                                                                            <li>Intro to State and Props</li>
                                                                            <li>React Events</li>
                                                                            <li>Form Handling</li>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form method="POST" action="{{route('courses.store')}}" class="lgx-contactform">
                                                                                            ...
                                                                                            <div>
                                                                                                ...
                                                                                                <input type="hidden" name="course" value="React JS">
                                                                                                <div class="form-group">
                                                            ...
                                                            <div class="tab-pane course-tab-panel-curriculum course-tab-panel" id="tab-curriculum">
                                                                <div class="learnpress-course-curriculum" data-section="" data-id="">
                                                                    <ul class="lp-skeleton-animation">
                                                                        <li style="width: 100%; height: 50px; color:black"><p style="padding-top: 12px;"></p></li>
                                                                        <li style="width: 100%; height: 26px; "><p></p></li>
                                                                        <li style="width: 100%; height: 26px; "><p></p></li>
                                                                        <li style="width: 100%; height: 26px; "><p></p></li>

                                                                        <li style="width: 100%; height: 50px; margin-top: 40px; color:black"><p style="padding-top: 12px;"></p></li>
                                                    ...
                                                    <div class="course-thumbnail">
                                                        <a class="thumb" href="{{route('ui-ux')}}">
                                                            <img src="{{asset('wp-content/uploads/sites/91/2022/09/ui-ux2.jpg')}}"
                                                                 alt="UI/UX & Graphics Design" title="UI UX" width="400" style="height: 13rem;object-fit: cover">
                                                        </a>
                                                    </div>
                                                    <div class="thim-course-content">
